...
def test_sequential_graph():
    """Test the graph nodes sequentially to demonstrate end-to-end functionality"""
    ...
    async def run_sequential():
        print("🚀 Starting sequential graph execution...")
        ...
        if approved:
            ...
            print("❌ Step 5: Skipped - story not approved")
